...
8. [Penjelasan tentang cara memakai *packages* di Dart menggunakan `pub`](https://dart.dev/guides/packages)
9. [Penjelasan tentang instalasai *shared packages*](https://dart.dev/tutorials/libraries/shared-pkgs).
