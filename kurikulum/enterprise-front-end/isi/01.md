...
6. Siswa memahami, mampu membuat, serta menjalankan *source code* JavaScript untuk sisi client (menggunakan *browser*).
8. Siswa memahami struktur dasar *source code* dalam bahasa pemrograman JavaScript untuk sisi *client* (*browser*).
